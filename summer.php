...
<b>Lock rules</b>
<br>
The lock keeper normally tries to keep the lower gate closed when he sees us approaching, if you do have to use the upper gate then he is ok about it, but be prepared to stop if he says so.  If you have breath then do say thanks.
You can stop your watch before doing the upper gate and re-start it when you reach the other side, this should allow for any occassions where you are delayed.
If you are near the back and there are boats waiting to go through the lock, and the lock keeper is waiting for us, then shout to him that you are the last one, or that there are x number of runners left to go.
<p></p>
