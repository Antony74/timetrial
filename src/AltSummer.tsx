...
const AltSummer: React.FunctionComponent = () => {
  return (
    <div>
      <h2>The Alternative Summer Course</h2>
      <img src="tempSummer.gif"></img>
      <br/>
      <p>
        Out of the main gate, run down the road towards Wallingford.  Turn left at the roundabout,
      ...
      <GenerateTable course="alternative Summer"></GenerateTable>
    </div>
  );
};

export default AltSummer;
