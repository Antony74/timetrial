...
const Winter: React.FunctionComponent = () => {
  return (
    <div>
      <h2>The 3 Mile Winter Course</h2>
      <img src="mapII.gif"/>
      <p>
        From the HR main gate, head down the road towards Wallingford.
        ...
        The finish is the side gate.
      </p>
      <GenerateTable course="Winter"></GenerateTable>
    </div>
  );
};
